...
<https://github.com/smeet666/mcp-animenewsnetwork/security/advisories/new>. It reaches me
...
This server is a read-only client for Anime News Network. It holds no credentials, needs no
API key, opens no port, and writes nothing back to Anime News Network. That rules out most
of what a vulnerability report usually concerns.

What remains is worth reporting:

- **Anything that lets a caller reach a host other than Anime News Network.** The URLs are
...
Rate limiting by Anime News Network, or Anime News Network being down, is the upstream's business and
